...
void Enemy::RandomizePosition()
{
	float randomY = cocos2d::random(
			groundHeight + visibleOrigin.y + sprite->getContentSize().height + sprite->getContentSize().height / 2,
		    visibleSize.height - visibleOrigin.y - sprite->getContentSize().height - sprite->getContentSize().height / 2);
